...
class LocaleBuildHook(BuildHookInterface):
    ...
    def initialize(self, version: str, build_data: dict) -> None:
        ...
        self.locale_path: Path = Path(self.root).joinpath("deepquant_ctabacktester", "locale")
        self.mo_path: Path = self.locale_path.joinpath("en", "LC_MESSAGES", "deepquant_ctabacktester.mo")
        self.po_path: Path = self.locale_path.joinpath("en", "LC_MESSAGES", "deepquant_ctabacktester.po")
