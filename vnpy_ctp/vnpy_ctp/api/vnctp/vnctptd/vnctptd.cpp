...
dict TdApi::getFrontInfo()
{
	CThostFtdcFrontInfoField d;
	this->api->GetFrontInfo(&d);

	dict data;
	data["FrontAddr"] = toUtf(d.FrontAddr);
	data["QryFreq"] = d.QryFreq;
	data["FTDPkgFreq"] = d.FTDPkgFreq;
	return data;
};
