...
from deepquant.trader.ui import QtWidgets, QtCore, QtGui
...
class ManagerWidget(QtWidgets.QWidget):
    ...
    def init_table(self) -> None:
        ...
        # K-line chart widget
        from deepquant.chart.kline_widget import KLineChartWidget
...
class DownloadDialog(QtWidgets.QDialog):
    ...
    def _load_products(self, exchange_code: str) -> None:
        ...
        def _fetch():
            try:
                from deepquant.trader.contract_cache import get_products
    ...
    def _load_contracts(self, exchange_code: str, product: str) -> None:
        ...
        def _fetch():
            try:
                from deepquant.trader.contract_cache import query_contracts, get_related_products
