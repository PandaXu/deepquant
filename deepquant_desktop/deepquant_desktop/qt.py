...
from deepquant.trader.utility import get_icon_path
...
def create_qapp(app_name: str = "VeighNa Trader") -> QtWidgets.QApplication:
    ...
    # Set up icon
    icon: QtGui.QIcon = QtGui.QIcon(get_icon_path(__file__, "deepquant.png"))
...
class ExceptionWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent: QtWidgets.QWidget | None = None) -> None:
        ...
        self.init_ui()
        self.signal.connect(self.show_exception, QtCore.Qt.ConnectionType.QueuedConnection)
